<%-- 
    Document   : specific_order_view_2
    Created on : Apr 25, 2021, 2:35:37 PM
    Author     : Welcome
--%>
...
<html>
    ...
    <body>
        <h2>Ordering : adidas NMD - Men Shoes</h2>
        <form action ="specific_order_view">
            <input type="hidden" name="prod" value="addidas NMD - Men Shoes">
