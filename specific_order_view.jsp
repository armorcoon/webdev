<%-- 
    Document   : specific_order_view
    Created on : Apr 25, 2021, 2:33:42 PM
    Author     : Welcome
--%>
...
<html>
    ...
    <body>
        <h2>Ordering : adidas Ultra Boost - Men Shoes</h2>
        <form action ="specific_order_view">
            <input type="hidden" name="prod" value="adidas Ultra Boost - Men Shoes">
